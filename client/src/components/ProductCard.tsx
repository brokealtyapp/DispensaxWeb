...
export function ProductCard({
  ...
  return (
    <Card
      className={`hover-elevate cursor-pointer ${isLowStock ? "border-destructive/50" : ""}`}
      onClick={onClick}
      data-testid={`card-product-${id}`}
    >
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          <div className={`p-3 rounded-lg ${isLowStock ? "bg-destructive/10 text-destructive" : "bg-muted"}`}>
